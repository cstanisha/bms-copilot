...
def get_greeting_response() -> str:
    ...
    return """Hello! I'm your Fire Protection Guide.
...
def main():
    ...
    <div class="header-container">
        <h1 class="header-title">🔥 Fire Protection AI Assistant</h1>
        <p class="header-subtitle">Professional guidance on fire protection documentation</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        if st.session_state.stats:
            ...
            st.code(st.session_state.stats['current_namespace'])
